...
#define MAP_ADDRESS0 16
#define MAP_ADDRESS1 17
#define MAP_ADDRESS2 18
#define MAP_ADDRESS3 19
...
int main() {
	...
	memcpy(&MAP[MAP_ADDRESS3][0], tile2Tiles+(rand()%(tile2TilesLen-tile2MapLen)), tile2MapLen);
